(function(){"use strict";const p=[{title:"欢迎",template:"Template:UserMessages/Welcome",parameters:[],summary:"Welcome to Moegirlpedia~"},{title:"优质编辑者",template:"Template:UserMessages/GoodEditor",parameters:[{key:"1",label:"选填原因"}],summary:"恭喜您成为萌娘百科优质编辑者！"},{title:"可收录页面打回",template:"Template:UserMessages/MovedToUserSubpage",parameters:[{key:"1",label:"页面名"},{key:"2",label:"原因"}],summary:"页面打回通知"},{title:"非收录页面打回",template:"Template:UserMessages/MovedToUserSubpage2",parameters:[{key:"1",label:"页面名"},{key:"2",label:"原因"}],summary:"页面打回通知"},{title:"著作权侵犯",template:"Template:UserMessages/ArticleCopyright",parameters:[{key:"1",label:"页面名"},{key:"2",label:"选填站点"}],summary:"请勿侵犯著作权"},{title:"不实信息",template:"Template:UserMessages/FalseInformation",parameters:[{key:"1",label:"页面名"}],summary:"请勿添加不实信息"},{title:"Wiki语法",template:"Template:UserMessages/WikiMarkupLanguage",parameters:[],summary:"关于Wiki语法"},{title:"剪贴移动",template:"Template:UserMessages/CutAndPasteMoving",parameters:[{key:"1",label:"页面名"}],summary:"请勿剪切移动页面"},{title:"编辑用户页",template:"Template:UserMessages/EditUserPage",parameters:[{key:"1",label:"页面名"}],summary:"请勿编辑他人用户页面"},{title:"幽默模板",template:"Template:UserMessages/HumorTemplate",parameters:[{key:"1",label:"选填页面名"},{key:"2",label:"选填行为"}],summary:"关于幽默模板的使用"},{title:"违规字词转换",template:"Template:UserMessages/ConversionViolation",parameters:[{key:"1",label:"选填页面名"},{key:"2",label:"选填行为"}],summary:"关于您近期的编辑"},{title:"文件授权协议",template:"Template:UserMessages/FileLicense",parameters:[{key:"1",label:"文件名"}],summary:"关于您近期上传的文件"},{title:"截图文件授权",template:"Template:UserMessages/FileLicense2",parameters:[{key:"1",label:"文件名"}],summary:"关于您近期上传的截图文件"},{title:"用户文件",template:"Template:UserMessages/UserFile",parameters:[],summary:"关于您上传的文件"},{title:"修改历史发言",template:"Template:UserMessages/DiscussionViolation",parameters:[{key:"1",label:"选填页面名或差异"}],summary:"关于您在讨论区的发言"},{title:"违反讨论区方针",template:"Template:UserMessages/DiscussionViolation2",parameters:[{key:"1",label:"页面名或差异"},{key:"2",label:"原因"}],summary:"关于您在讨论区的发言"},{title:"删除历史发言",template:"Template:UserMessages/DiscussionViolation3",parameters:[{key:"1",label:"选填页面名或差异"}],summary:"关于您在讨论区的行为"},{title:"人身攻击提醒",template:"Template:UserMessages/PersonalAttacks",parameters:[{key:"1",label:"页面名"},{key:"2",label:"选填用户"}],summary:"请勿人身攻击"},{title:"人身攻击警告",template:"Template:UserMessages/PersonalAttacks2",parameters:[],summary:"人身攻击警告"},{title:"未签名",template:"Template:UserMessages/Signature",parameters:[{key:"1",label:"页面名"}],summary:"关于您的签名"},{title:"签名违规",template:"Template:UserMessages/Signature2",parameters:[{key:"1",label:"页面名"}],summary:"关于您的签名"},{title:"编辑战通知",template:"Template:UserMessages/EditWar",parameters:[{key:"1",label:"页面名"}],summary:"提醒您参与讨论"},{title:"编辑战提醒",template:"Template:UserMessages/EditWar2",parameters:[{key:"1",label:"页面名"}],summary:"编辑战提醒"},{title:"编辑战警告",template:"Template:UserMessages/EditWar3",parameters:[{key:"1",label:"页面名"},{key:"2",label:"选填原因"}],summary:"编辑战警告"},{title:"最终警告",template:"Template:UserMessages/FinalWarning",parameters:[{key:"1",label:"选填原因"},{key:"2",label:"选填原因"}],summary:"警告：忍耐是有限的"},{title:"大家族模板排序",template:"Template:UserMessages/NavSort",parameters:[{key:"1",label:"页面名"}],summary:"关于大家族模板的排序"},{title:"回复无缩进",template:"Template:UserMessages/ReplyNoIndentation",parameters:[{key:"1",label:"页面名"},{key:"2",label:"被回复人"}],summary:"关于您在讨论区的发言"},{title:"超速编辑",template:"Template:UserMessages/OverSpeedEdit",parameters:[],summary:"关于您近期的编辑"}];mw.loader.using(["mediawiki.api","@wikimedia/codex"]).then(function(r){const m=mw.config.get("wgNamespaceNumber"),n=mw.config.get("wgCanonicalSpecialPageName");if(![1,2,-1].includes(m)||m===-1&&!["Contributions","DeletedContributions","Block","Log"].includes(n))return;const o=mw.util.addPortletLink("p-cactions","#","向用户发送提醒","p-usermessages"),c=r("vue"),a=r("@wikimedia/codex"),d=document.body.appendChild(document.createElement("div")),l=new mw.Api;mw.util.addCSS(`
	...
	`),c.createMwApp({data(){return{showDialog:!1,selected:null,editSummary:"",showPreview:!1,previewHtml:"",previewWikitext:"",parameterValues:{},customMode:!1,customText:"",loadingSource:!1,sending:!1,templates:p,primaryAction:{label:"预览",actionType:"progressive"}}},computed:{menuItems(){return this.templates.map((t,e)=>({label:t.title,value:e}))},selectedTemplate(){return this.selected!==null&&this.templates[this.selected]||null},previewActions(){return{default:{label:"关闭"},primary:{label:this.sending?"发送中...":"发送提醒",actionType:"progressive",disabled:this.sending}}}},watch:{selected(t){t!==null&&(this.editSummary=this.templates[t].summary,this.parameterValues={},this.customMode=!1,this.customText="")},async customMode(t){t&&this.selectedTemplate&&await this.loadTemplateSource(this.selectedTemplate.template)}},template:`
			<cdx-dialog
		...
		`,methods:{openDialog(){this.showDialog=!0},async loadTemplateSource(t){this.loadingSource=!0;try{let s=(await l.get({action:"query",prop:"revisions",rvprop:"content",titles:t,formatversion:2})).query.pages[0].revisions?.[0]?.content||"";s=s.replace(/<noinclude>[\s\S]*?<\/noinclude>/gi,"").replace(/<includeonly>/gi,"").replace(/<\/includeonly>/gi,""),this.customText=s.trim()}catch(e){this.customText=`加载模板源代码失败：${e}`}finally{this.loadingSource=!1}},async previewTemplate(){let t="";if(this.customMode)t=this.customText;else{const e=this.selectedTemplate;if(!e)return;t=`{{${e.template}`,e.parameters?.length&&e.parameters.forEach(i=>{const s=this.parameterValues[i.key];s&&(t+=`|${i.key}=${s}`)}),t+="}}"}this.previewWikitext=t;try{const e=await l.post({action:"parse",text:t,contentmodel:"wikitext",format:"json"});this.previewHtml=e.parse.text["*"],this.showPreview=!0}catch(e){this.previewHtml=`<div style="color:red;">预览出错：${e}</div>`,this.showPreview=!0}},async sendToTalkPage(){const t=mw.config.get("wgRelevantUserName");this.sending=!0;try{let e=this.previewWikitext;!this.customMode&&this.selectedTemplate&&(e=this.previewWikitext.replace(/^{{/,"{{subst:")),await l.postWithToken("csrf",{action:"edit",assertuser:mw.config.get("wgUserName"),format:"json",title:`User talk:${t}`,section:"new",sectiontitle:"",text:`${e} ——~~~~`,summary:this.editSummary,tags:"Automation tool|UserMessages"}),mw.notify("已成功发送到讨论页",{type:"success"}),this.showPreview=!1,this.showDialog=!1}catch(e){mw.notify(`发送失败：${e}`,{type:"error"})}finally{this.sending=!1}}},mounted(){o.addEventListener("click",this.openDialog)},unmounted(){o.removeEventListener("click",this.openDialog)}}).component("cdx-dialog",a.CdxDialog).component("cdx-field",a.CdxField).component("cdx-text-input",a.CdxTextInput).component("cdx-text-area",a.CdxTextArea).component("cdx-select",a.CdxSelect).component("cdx-button",a.CdxButton).component("cdx-checkbox",a.CdxCheckbox).mount(d)})})();
