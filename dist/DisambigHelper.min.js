(function(){"use strict";$(function(){if(!mw.config.get("wgIsArticle")||mw.config.get("wgPageContentModel")!=="wikitext")return;const N={loading:"加载中...",loadingFailed:"( ﾟ∀。)加载失败",editing:"修改中...",edited:"修改成功！正在刷新页面...",editFailed:"( ﾟ∀。)修改失败",disambig:"消歧义"};mw.config.get().wgUserLanguage==="zh-hant"&&(N.loading="加載中...",N.loadingFailed="( ﾟ∀。)加載失敗",N.editing="修改中...",N.edited="修改成功！正在刷新頁面...",N.editFailed="( ﾟ∀。)修改失敗",N.disambig="消歧義");const l='<img class="icon" alt="edit" src="data:image/svg+xml;base64,">',s='<img class="icon" alt="edit_all" src="data:image/svg+xml;base64,">',D='<img class="icon" alt="link" src="data:image/svg+xml;base64,">';$("body").append(`<style>
    ...
    </style>`);const c=i=>decodeURI($(i).attr("href").substring(1)).replace(/%2F/g,"/"),o=i=>new Promise(t=>{new mw.Api().get({action:"parse",page:i,redirects:!0,prop:"wikitext",format:"json"}).done(z=>{t(z.parse.wikitext["*"])}).fail((z,a,e)=>{t(e)})}),Y=(function(){const i={};return $(".mw-disambig").each(function(){const t=c(this);i[t]=i[t]+1||0}),i})();$(".mw-disambig").each(async function(){const i=c(this),t=$(this).text();let z=i.split(".").join("");const a=$(`#${z}`).length;a>0&&(z=z+a+1);const e=Y[i]===0?l:s,g=j=>{$(`#${z} ul`).empty().append(`<li>${j}</li>`)};$(this).after($("<div>",{id:z,class:"disambig-box"}).on("mouseleave",()=>{$(`#${z}`).hide(150,"swing")}).append('<ul class="disambig-ul">'),$("<sup>").append($("<a>",{href:"javascript:void(0)",text:"?",class:z}))),$(`a.${z}`).on("mouseenter",async()=>{$(`#${z}`).css({left:$(this).position().left+10,top:$(this).position().top+16}),g(N.loading),$(`#${z}`).show(150,"swing");let j=await o(i);if(j=j.split(`
`).map(M=>M.substring(0,M.indexOf("——"))).map(M=>{if(M.match(/\[\[/g)&&!M.match(/\[\[File:/gi))return M.split("[[")[1].split("]]")[0];if(M.match(/\{\{(dis|dl)\|/gi))return M.split(/\{\{(dis|dl)\|/gi)[1];if(M.match(/\{\{coloredlink\|/gi))return M.split(/\{\{coloredlink\|/gi)[1]}).filter(M=>M).map(M=>M.split("|")[0]),$(`#${z} ul`).empty(),!j[0])return g(N.loadingFailed);for(const M of j){const I=M.replace(/"/g,"&quot;");$(`#${z} ul`).append(`<li id="${I}">${M}<a href="/${I}">${D}</a><a>${e}</a></li>`),document.getElementById(M).lastChild.addEventListener("click",async()=>{g(N.editing);const d=mw.config.get().wgPageName,A=await o(d);let n=`[[${i}]]`;i!==t&&(n=`[[${i}|${t}]]`),new mw.Api().postWithToken("csrf",{action:"edit",text:A.replaceAll(n,`[[${M}|${t}]]`),title:d,minor:!0,nocreate:!0,summary:`${N.disambig}：[[${i}]]→[[${M}]]`,tags:"Automation tool",errorformat:"plaintext"}).done(()=>{g(N.edited),window.location.reload()}).fail((u,m,y)=>{g(`${N.editFailed}（${y}）`)})})}})})})})();
