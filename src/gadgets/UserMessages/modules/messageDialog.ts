 ...
 */
export function showMessage(spec: MessageSpec, actions: OO.ui.ActionWidget.ConfigOptions[]): Promise<string> {
 ...
 * @param message 正文
 */
export async function confirmRetry(title: string, message: string): Promise<'retry' | 'close'> {
